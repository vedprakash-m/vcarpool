...
describe('useAuthStore', () => {
  ...
  describe('login', () => {
    it('should handle successful login', async () => {
      ...
      expect(mockApiClient.setToken).toHaveBeenCalledWith('mock-access-token', 'mock-refresh-token');
  ...
  describe('refreshAuth', () => {
    it('should refresh authentication with valid refresh token', async () => {
      ...
      mockApiClient.refreshAccessToken.mockResolvedValueOnce('new-access-token');
    ...
    it('should handle refresh failure', async () => {
      ...
      mockApiClient.refreshAccessToken.mockRejectedValueOnce(new Error('Invalid refresh token'));
