...
exports.statAsync = (0, node_util_1.promisify)(fs.stat);
exports.lstatAsync = (0, node_util_1.promisify)(fs.lstat);
exports.mkdirAsync = (0, node_util_1.promisify)(fs.mkdir);
exports.accessAsync = (0, node_util_1.promisify)(fs.access);
exports.appendFileAsync = (0, node_util_1.promisify)(fs.appendFile);
exports.writeFileAsync = (0, node_util_1.promisify)(fs.writeFile);
exports.readFileAsync = (0, node_util_1.promisify)(fs.readFile);
exports.readdirAsync = (0, node_util_1.promisify)(fs.readdir);
exports.unlinkAsync = (0, node_util_1.promisify)(fs.unlink);
/**
