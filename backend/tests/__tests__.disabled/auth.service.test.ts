...
describe('AuthService', () => {
  ...
  describe('User Authentication Flow', () => {
    it('should authenticate user with valid credentials', async () => {
      ...
      const isValidPassword = await authService.verifyPassword(password, foundUser.passwordHash);
    ...
    it('should reject authentication with invalid password', async () => {
      ...
      const foundUser = await mockUserRepository.findByEmail(email);
      const isValidPassword = await authService.verifyPassword(wrongPassword, foundUser.passwordHash);
