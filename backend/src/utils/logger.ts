...
export class AzureLogger implements ILogger {
  ...
  private logToAzureFunctions(level: LogLevel, logEntry: any): void {
  ...
  private logToApplicationInsights(level: LogLevel, logEntry: any): void {
...
export class LoggerFactory {
  ...
  create(service: string, metadata: Record<string, any> = {}): ILogger {
...
export class LoggingUtils {
   ...
   */
  static performance<T extends any[], R>(
    logger: ILogger,
    operation: string
  ) {
